...
void AnimationMGR::Initialize()
{
	...
	Object_Shapes[E_OBJECT::E_ITEM] = "£¿";
	Object_Shapes[E_OBJECT::E_ITEM + 1] = "¢¯";
	...
	Object_Shapes[E_OBJECT::E_EFFECT_ATTACK + 1] = "¤ý";
	...
	{
		Object_Animation[E_OBJECT::E_ITEM].emplace_back(E_OBJECT::E_ITEM);
		Object_Animation[E_OBJECT::E_ITEM].emplace_back(E_OBJECT::E_ITEM + 1);
	}
	{
